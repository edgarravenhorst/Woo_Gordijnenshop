...
jQuery(document).ready(function () {
  ...
  var mainmenu = new Menu({
    ...
    events: {
      swipeLeft: function swipeLeft(menu, e) {
        menu.close();
      }
...
/* WEBPACK VAR INJECTION */(function(jQuery, __webpack_provided_window_dot_jQuery) {window._ = __webpack_require__(8);

window.$ = __webpack_provided_window_dot_jQuery = jQuery || __webpack_require__(0);
window.Tether = __webpack_require__(9);
