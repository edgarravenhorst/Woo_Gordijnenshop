...
class Iconic_WSSV_WP_All_Import {
    ...
    public function format_visibility( $post_id, $meta_key, $meta_value ) {
        ...
        $visibility = array_map( 'trim', explode( ',', $meta_value ) );

        Iconic_WSSV_Product_Variation::set_visibility( $post_id, $visibility );
    ...
    public function format_featured( $post_id, $meta_key, $meta_value ) {
        ...
        Iconic_WSSV_Product_Variation::set_featured_visibility( $post_id, $meta_value );
